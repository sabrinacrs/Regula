...
namespace RegulaPrism
{
    public partial class App : PrismApplication
    {
        ...
        protected override void OnInitialized()
        {
            ...
            NavigationService.NavigateAsync("NavigationPage/LoginPage"); //  LoginPage HomeMasterDetailPage  MainPage?title=Hello%20from%20Xamarin.Forms
        }
        ...
        protected override void RegisterTypes()
        {
            ...
            Container.RegisterTypeForNavigation<InformacoesPage>();
        }
    }
}
